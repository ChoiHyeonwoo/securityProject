package com.spring.security.core.configs;

import com.spring.security.core.common.FormWebAuthenticationDetailsSource;
import com.spring.security.core.factory.UrlResourcesMapFactoryBean;
import com.spring.security.core.filter.PermitAllFilter;
import com.spring.security.core.handler.FormAccessDeniedHandler;
import com.spring.security.core.metadatasource.UrlFilterInvocationSecurityMetadataSource;
import com.spring.security.core.provider.FormAuthenticationProvider;
...
//        accessDecisionVoters.add(new IpAddressVoter(securityResourceService)); -> ip 체크하는 voter까지 추가 (얘가 먼저 가야함.)
    ...
    // UrlResourcesMapFactoryBean을 등록.
